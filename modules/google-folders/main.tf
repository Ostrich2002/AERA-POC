# -------------------------------only folder and project creation with linking to billing account
...
# Loop over target folders and create projects, linking to the billing account
...
resource "google_project_billing" "billing" {
  for_each      = google_project.projects
  project_id    = each.value.project_id
  billing_account = "<YOUR_BILLING_ACCOUNT_ID>"  # Replace with your billing account ID
}
